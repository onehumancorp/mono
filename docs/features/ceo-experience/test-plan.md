...
- Frontend build (Flutter) running locally.
- Backend mocked or running at `localhost:8080`.

## Implementation Details
- **Architecture**: The frontend is tested using Flutter for unit tests (Riverpod state, D3.js logic) and Playwright for End-to-End UI testing. The Go 1.26 backend uses Table-Driven Tests for the REST/SSE endpoints.
