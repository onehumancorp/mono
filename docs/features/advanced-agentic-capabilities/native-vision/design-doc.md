...
## 1. Overview
This design document describes the technical implementation of Native Vision.

## 2. Architecture
The Native Vision feature integrates directly into the core Orchestration Hub.
...
## 3. Data Model
Events related to Native Vision will be stored in the append-only event log with the following schema updates:
- `event_type`: ``
