...
## 1. Overview
This design document describes the technical implementation of B2b Spiffe Federation.

## 2. Architecture
The B2b Spiffe Federation feature integrates directly into the core Orchestration Hub.
...
## 3. Data Model
Events related to B2b Spiffe Federation will be stored in the append-only event log with the following schema updates:
- `event_type`: ``
