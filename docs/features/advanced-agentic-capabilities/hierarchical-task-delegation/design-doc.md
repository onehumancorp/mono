# Design Doc: Hierarchical Task Delegation
...
The Hierarchical Task Delegation capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Hierarchical Task Delegation logic.
...
- **Context Limit Breaches**: If Hierarchical Task Delegation payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
