# Design Doc: Parallel Map-Reduce Execution
...
The Parallel Map-Reduce Execution capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Parallel Map-Reduce Execution logic.
...
- **Context Limit Breaches**: If Parallel Map-Reduce Execution payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
