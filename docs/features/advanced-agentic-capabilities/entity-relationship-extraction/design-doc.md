# Design Doc: Entity Relationship Extraction
...
The Entity Relationship Extraction capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Entity Relationship Extraction logic.
...
- **Context Limit Breaches**: If Entity Relationship Extraction payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
