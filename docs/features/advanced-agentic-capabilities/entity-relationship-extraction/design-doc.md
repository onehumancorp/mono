...
Integrates deeply with the Model Context Protocol (MCP) and Kubernetes operator to provide entity relationship extraction capabilities seamlessly across all active Swarm Agents.
