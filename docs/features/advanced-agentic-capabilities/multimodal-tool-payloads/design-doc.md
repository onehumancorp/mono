# Design Doc: Multimodal Tool Payloads
...
The Multimodal Tool Payloads capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Multimodal Tool Payloads logic.
...
- **Context Limit Breaches**: If Multimodal Tool Payloads payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
