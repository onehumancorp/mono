# Design Doc: Token-Efficient Context Summarization
...
The Token-Efficient Context Summarization capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Token-Efficient Context Summarization logic.
...
- **Context Limit Breaches**: If Token-Efficient Context Summarization payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
