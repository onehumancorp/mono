# Design Doc: Spatial Object Recognition
...
The Spatial Object Recognition capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Spatial Object Recognition logic.
...
- **Context Limit Breaches**: If Spatial Object Recognition payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
