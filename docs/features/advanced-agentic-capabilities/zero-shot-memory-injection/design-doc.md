# Design Doc: Zero-Shot Memory Injection
...
The Zero-Shot Memory Injection capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Zero-Shot Memory Injection logic.
...
- **Context Limit Breaches**: If Zero-Shot Memory Injection payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
