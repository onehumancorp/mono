...
Integrates deeply with the Model Context Protocol (MCP) and Kubernetes operator to provide openapi spec to tool auto-mapping capabilities seamlessly across all active Swarm Agents.
