# Design Doc: Token Burn-Rate Forecasting
...
The Token Burn-Rate Forecasting capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Token Burn-Rate Forecasting logic.
...
- **Context Limit Breaches**: If Token Burn-Rate Forecasting payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
