# Design Doc: Audio Command Transcription
...
The Audio Command Transcription capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Audio Command Transcription logic.
...
- **Context Limit Breaches**: If Audio Command Transcription payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
