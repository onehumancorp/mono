...
## 1. Overview
This design document describes the technical implementation of Asynchronous Event Pub Sub.

## 2. Architecture
The Asynchronous Event Pub Sub feature integrates directly into the core Orchestration Hub.
...
## 3. Data Model
Events related to Asynchronous Event Pub Sub will be stored in the append-only event log with the following schema updates:
- `event_type`: ``
