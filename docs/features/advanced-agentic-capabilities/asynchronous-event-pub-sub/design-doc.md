# Design Doc: Asynchronous Event Pub/Sub
...
The Asynchronous Event Pub/Sub capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Asynchronous Event Pub/Sub logic.
...
- **Context Limit Breaches**: If Asynchronous Event Pub/Sub payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
