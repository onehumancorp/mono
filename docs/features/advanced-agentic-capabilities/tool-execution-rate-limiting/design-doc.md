...
Implements map-based trackers or rate limiters in the Go backend to rate limit state by AgentID and ToolID. Ensures bounded memory growth by explicitly deleting map entries upon successful execution or resolving the tracked state.
