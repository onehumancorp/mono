# Design Doc: Voice Synthesis for Agent Reports
...
The Voice Synthesis for Agent Reports capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Voice Synthesis for Agent Reports logic.
...
- **Context Limit Breaches**: If Voice Synthesis for Agent Reports payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
