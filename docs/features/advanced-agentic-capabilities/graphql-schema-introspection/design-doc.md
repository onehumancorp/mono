...
Integrates deeply with the Model Context Protocol (MCP) and Kubernetes operator to provide graphql schema introspection capabilities seamlessly across all active Swarm Agents.
