# Design Doc: Image-to-Text Grounding
...
The Image-to-Text Grounding capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Image-to-Text Grounding logic.
...
- **Context Limit Breaches**: If Image-to-Text Grounding payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
