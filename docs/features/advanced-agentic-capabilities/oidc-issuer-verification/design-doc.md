...
## 1. Overview
This design document describes the technical implementation of Oidc Issuer Verification.

## 2. Architecture
The Oidc Issuer Verification feature integrates directly into the core Orchestration Hub.
...
## 3. Data Model
Events related to Oidc Issuer Verification will be stored in the append-only event log with the following schema updates:
- `event_type`: ``
