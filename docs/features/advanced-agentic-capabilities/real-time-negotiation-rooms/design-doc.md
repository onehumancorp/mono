# Design Doc: Real-Time Negotiation Rooms
...
The Real-Time Negotiation Rooms capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Real-Time Negotiation Rooms logic.
...
- **Context Limit Breaches**: If Real-Time Negotiation Rooms payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
