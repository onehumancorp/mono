...
## 1. Overview
This design document describes the technical implementation of Real Time Negotiation Rooms.

## 2. Architecture
The Real Time Negotiation Rooms feature integrates directly into the core Orchestration Hub.
...
## 3. Data Model
Events related to Real Time Negotiation Rooms will be stored in the append-only event log with the following schema updates:
- `event_type`: ``
