# Design Doc: Working Memory Scratchpad
...
The Working Memory Scratchpad capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Working Memory Scratchpad logic.
...
- **Context Limit Breaches**: If Working Memory Scratchpad payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
