...
## 1. Overview
This design document describes the technical implementation of Stateful Episodic Memory.

## 2. Architecture
The Stateful Episodic Memory feature integrates directly into the core Orchestration Hub.
...
## 3. Data Model
Events related to Stateful Episodic Memory will be stored in the append-only event log with the following schema updates:
- `event_type`: ``
