# Design Doc: Zero-Trust Secret Injection
...
The Zero-Trust Secret Injection capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Zero-Trust Secret Injection logic.
...
- **Context Limit Breaches**: If Zero-Trust Secret Injection payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
