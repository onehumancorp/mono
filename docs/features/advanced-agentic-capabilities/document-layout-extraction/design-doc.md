...
Integrates deeply with the Model Context Protocol (MCP) and Kubernetes operator to provide document layout extraction capabilities seamlessly across all active Swarm Agents.
