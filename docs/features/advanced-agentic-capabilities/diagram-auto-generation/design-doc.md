# Design Doc: Diagram Auto-Generation
...
The Diagram Auto-Generation capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Diagram Auto-Generation logic.
...
- **Context Limit Breaches**: If Diagram Auto-Generation payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
