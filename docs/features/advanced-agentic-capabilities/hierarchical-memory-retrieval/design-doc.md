# Design Doc: Hierarchical Memory Retrieval
...
The Hierarchical Memory Retrieval capability is injected directly into the active LangGraph execution thread.
...
1. **Core Processing Engine**: Evaluates active thread state and applies Hierarchical Memory Retrieval logic.
...
- **Context Limit Breaches**: If Hierarchical Memory Retrieval payload exceeds max token limits, the Semantic Distillation worker is triggered to summarize context.
