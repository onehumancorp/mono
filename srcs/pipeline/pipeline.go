...
//
// Accepts parameters:
//   - msg: sip.Message; The EventSpecApproved message containing branch and detail data.
//
...
func (o *Orchestrator) HandleSpecApproved(msg sip.Message) error {
...
//
// Accepts parameters:
//   - msg: sip.Message; The PR creation message where the content is the branch name.
//
...
func (o *Orchestrator) HandlePRCreated(msg sip.Message) error {
...
//
// Accepts parameters:
//   - msg: sip.Message; The CI result message indicating pass or fail, including branch and logs.
//
...
func (o *Orchestrator) HandleTestResults(msg sip.Message) error {
	// ⚡ BOLT: [context window parsing/summarization overhead] - Randomized Selection from Top 5
