...
/**
 * @summary Fetches proactive insights dynamically generated by the backend.
 * @param None
 * @returns Promise<ProactiveInsight[]>
 * @throws May throw an error
 * @remarks Side Effects: None
 */
export function fetchProactiveInsights(): Promise<import("./types").ProactiveInsight[]> {
  return authedGetJSON<import("./types").ProactiveInsight[]>("/api/insights");
}
/**
