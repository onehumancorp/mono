...
import { fetchMarketplace, importMarketplaceBlueprint } from "./api";
import {
  connectIntegration,
...
type NavSection = "overview" | "meetings" | "agents" | "handoffs" | "cost" | "playbooks" | "integrations" | "scaling" | "settings" | "users" | "marketplace";
...
export function App() {
  ...
  useEffect(() => {
    ...
    if (activeNav === "marketplace") {
      ...
      fetchMarketplace()
        .then(setMarketplaceItems)
        .catch(() => setNotice("Failed to load marketplace items."))
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            // Refresh agents
                            fetchDashboard().then(setSnapshot).catch(() => {});
                          } catch (err: any) {
