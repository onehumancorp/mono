...
func NewServer(org domain.Organization, hub *orchestration.Hub, tracker *billing.Tracker, authStore ...*auth.Store) http.Handler {
	...
	mux.HandleFunc("/api/v1/scale", server.handleScaleAgents)
...
func seededLaunchReadiness(now time.Time) (domain.Organization, *orchestration.Hub, *billing.Tracker, error) {
	...
	hub.RegisterAgent(orchestration.Agent{ID: "swe-1", Name: "Software Engineer Bot 1", Role: "swe", OrganizationID: org.ID})
	hub.RegisterAgent(orchestration.Agent{ID: "swe-2", Name: "Software Engineer Bot 2", Role: "swe", OrganizationID: org.ID})
	hub.RegisterAgent(orchestration.Agent{ID: "swe-3", Name: "Software Engineer Bot 3", Role: "swe", OrganizationID: org.ID})
	hub.RegisterAgent(orchestration.Agent{ID: "swe-4", Name: "Software Engineer Bot 4", Role: "swe", OrganizationID: org.ID})
	hub.RegisterAgent(orchestration.Agent{ID: "sales-1", Name: "Sales Rep Bot 1", Role: "sales_rep", OrganizationID: org.ID})
	hub.RegisterAgent(orchestration.Agent{ID: "sales-2", Name: "Sales Rep Bot 2", Role: "sales_rep", OrganizationID: org.ID})
	hub.RegisterAgent(orchestration.Agent{ID: "support-1", Name: "Support Bot 1", Role: "support", OrganizationID: org.ID})
