...
func TestSPIFFEAuthInterceptor_OneHumanCorp_ZeroSlashes(t *testing.T) {
	interceptor := SPIFFEAuthInterceptor()
	ctx := mockSPIFFEContext("spiffe://onehumancorp.io/orgID") // 0 slashes after domain

	req := pb.PublishMessageRequest_builder{
		Message: pb.Message_builder{FromAgent: "agentID"}.Build(),
	}.Build()
...
func TestSPIFFEAuthInterceptor_OhcOs_ZeroSlashes(t *testing.T) {
	interceptor := SPIFFEAuthInterceptor()
	ctx := mockSPIFFEContext("spiffe://ohc.os/agentID") // 0 slashes after domain
...
func TestSPIFFEStreamInterceptor_OneHumanCorp_ZeroSlashes(t *testing.T) {
	interceptor := SPIFFEStreamInterceptor()
	ctx := mockSPIFFEContext("spiffe://onehumancorp.io/orgID")

	stream := &mockServerStream{
		ctx: ctx,
		req: pb.StreamMessagesRequest_builder{AgentId: "agentID"}.Build(),
	}
	err := interceptor(nil, stream, nil, func(srv interface{}, stream grpc.ServerStream) error { return nil })
	if err == nil {
		t.Fatal("expected error")
	}
}

func TestSPIFFEStreamInterceptor_OhcOs_ZeroSlashes(t *testing.T) {
	interceptor := SPIFFEStreamInterceptor()
	ctx := mockSPIFFEContext("spiffe://ohc.os/agentID")
...
func TestSPIFFEAuthInterceptor_OneHumanCorp_InvalidSlashCount_Publish(t *testing.T) {
	interceptor := SPIFFEAuthInterceptor()
	ctx := mockSPIFFEContext("spiffe://onehumancorp.io/orgID/agentID/extra")
...
func TestSPIFFEAuthInterceptor_OhcOs_InvalidPrefix_Publish(t *testing.T) {
	interceptor := SPIFFEAuthInterceptor()
	ctx := mockSPIFFEContext("spiffe://ohc.os/notagent/agentID")
...
func TestSPIFFEStreamInterceptor_OneHumanCorp_InvalidSlashCount_Stream(t *testing.T) {
	interceptor := SPIFFEStreamInterceptor()
	ctx := mockSPIFFEContext("spiffe://onehumancorp.io/orgID/agentID/extra")
...
func TestSPIFFEStreamInterceptor_OhcOs_InvalidPrefix_Stream(t *testing.T) {
	interceptor := SPIFFEStreamInterceptor()
	ctx := mockSPIFFEContext("spiffe://ohc.os/notagent/agentID")
...
func TestSPIFFEAuthInterceptor_OneHumanCorp_ZeroSlashes_Publish(t *testing.T) {
	interceptor := SPIFFEAuthInterceptor()
	ctx := mockSPIFFEContext("spiffe://onehumancorp.io/orgID") // 0 slashes after domain
...
func TestSPIFFEAuthInterceptor_OhcOs_ZeroSlashes_Publish(t *testing.T) {
	interceptor := SPIFFEAuthInterceptor()
	ctx := mockSPIFFEContext("spiffe://ohc.os/agentID") // 0 slashes after domain
...
func TestSPIFFEStreamInterceptor_OneHumanCorp_ZeroSlashes_Stream(t *testing.T) {
	interceptor := SPIFFEStreamInterceptor()
	ctx := mockSPIFFEContext("spiffe://onehumancorp.io/orgID")
...
func TestSPIFFEStreamInterceptor_OhcOs_ZeroSlashes_Stream(t *testing.T) {
	interceptor := SPIFFEStreamInterceptor()
	ctx := mockSPIFFEContext("spiffe://ohc.os/agentID")
