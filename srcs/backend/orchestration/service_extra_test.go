...
func TestPublish_ContextSummarization_Success(t *testing.T) {
	...
	meeting := hub.OpenMeeting("kickoff", "org-1", "Kickoff", []string{"pm-1", "swe-1"})
...
func TestPublish_MeetingChannelFull(t *testing.T) {
	...
	hub.OpenMeeting("kickoff", "org-1", "Kickoff", []string{"pm-1", "swe-1"})
...
func (m *mockStreamMessagesServerError) Send(msg *commonpb.Message) error {
