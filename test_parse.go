...
func main() {
	...
	parse("spiffe://onehumancorp.io/org-1/attacker/../agent-1")
	parse("spiffe://onehumancorp.io/org-1/agent-1?")
	parse("spiffe://ohc.os/agent/agent-1")
	parse("spiffe://ohc.os/agent/attacker/../agent-1")
	parse("spiffe://ohc.local/org/org-1/agent/agent-1")
	parse("spiffe://ohc.global/org/org-1/agent/agent-1")
	parse("spiffe://ohc.global/org/org-1/agent/agent-1/..")
	parse("spiffe://eu.ohc.global/org/org-1/agent/agent-1")
}
